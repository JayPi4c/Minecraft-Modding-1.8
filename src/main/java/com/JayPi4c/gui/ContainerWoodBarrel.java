...
public class ContainerWoodBarrel extends Container {
        ...
        public ContainerWoodBarrel(IInventory playerInv, TileEntityWoodBarrel wood_barrel) {
                int i = -18;
        int j;
        int k;
        ...
        int index = 0;
                for (j = 0; j < 3; ++j) {
            for (k = 0; k < 5; ++k) {
                addSlotToContainer(new Slot(wood_barrel.inventory, index++, 44 + k * 18, 17 + j * 18));
            }
        }
