...
public class TileEntityWoodBarrel extends TileEntity {
	
	public InventoryBasic inventory;
	
	public TileEntityWoodBarrel(){
		inventory = new InventoryBasic("WoodBarrelInventory", false, 15);
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.inventory = new InventoryBasic("WoodBarrelInventory", false, 15);
